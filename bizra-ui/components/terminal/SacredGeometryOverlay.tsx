...
export function SacredGeometryOverlay() {
  return (
    <div className="sacred-overlay fixed top-0 left-0 w-full h-full z-1 pointer-events-none opacity-8">
      <svg className="flower-of-life absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] animate-spin-sacred">
        <defs>
